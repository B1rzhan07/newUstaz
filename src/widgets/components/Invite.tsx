...
function Invite() {
  return (
    <Box>
      <TypographyHeadingStyle>Қатысуға шақырамыз</TypographyHeadingStyle>
      <BoxContainerStyle>
        <BoxStyle>
          <Typography
            sx={{
          ...
          >
            <li>
              Конкурсқа Алматы қаласының мемлекеттік білім беру ұйымдарындағы оқу жоспарының барлық
              пәндері бойынша 36 жасқа дейін қоса алғанда 1-11 сынып мұғалімдері қатыса алады
            </li>
          </Typography>
          <Box
            sx={{
          ...
          >
            ...
            >
              Электрондық тіркеуден өтіп, сауалнаманы толтырыңыз
            </Typography>
          </Box>
          <Box
            sx={{
          ...
          >
            ...
            >
              Aкадемиялық адалдық қағидаттарын сақтаңыз
            </Typography>
          </Box>
          <TypographyStyle>Байқауды ұйымдастырушы</TypographyStyle>
          <Box
            sx={{
              display: 'flex',
              alignItems: 'center',
...
const ImageContainerStyle = styled('img')(({ theme }) => ({
  height: 60,
  alignItems: 'center',
  [theme.breakpoints.down('sm')]: {
    height: 40,
